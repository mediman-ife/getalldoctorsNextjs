...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      title:
        "MediMan | Healthcare. Anytime. Anywhere. | Book Doctor Appointments Online",
      description:
        "Find your favourite doctors, get e-prescriptions, manage appointments and followups, and keep your medical records securely in one app. Download MediMan App Now!",
      keywords: [
        "MediMan",
        "Doctor Booking",
        "Sri Lanka Doctors",
    ...
    return {
      title: "MediMan | Healthcare. Anytime. Anywhere.",
      description:
        "Find and book appointments with top doctors in Sri Lanka. Online and clinic consultations available.",
    };
  }
}
